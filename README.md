...
Once the server is set up, you still have two steps to get your nodes under control of Puppet:
- to set up the bootstrapping for the automatic enrollement of machines;
